...
@section('content')
                            ...
                            <div class="product-item">
                                <div class="position-relative text-center">
                                    <img class="img-fluid" src="{{ asset('storage/' . $product->image) }}"
                                        alt="" loading="lazy" style="max-height: 250px;object-fit:fill" >
                                </div>
    ...
    <a href="#" class="btn btn-lg btn-primary btn-lg-square rounded-circle position-fixed bottom-0 end-0 mb-3 me-3">
        <i class="bi bi-cart"></i>
        <span class="badge rounded-circle bg-danger position-absolute top-0 start-100 translate-middle" style="width: 25px; height: 25px; font-size: 14px; text-align: center; line-height: 16px;transform: translate(-73%, -37%) !important;">
            5
        </span>
    </a>
...
@section('modal')
    <div class="modal fade" wire:ignore.self id="loginModal" data-bs-backdrop="static"
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control translate-nepali" id="farmer_number" wire:model="farmer_number" placeholder="कृषक नम्बर लेख्नुहोस्">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" id="password" wire:model="password" placeholder="पासवर्ड लेख्नुहोस्">
