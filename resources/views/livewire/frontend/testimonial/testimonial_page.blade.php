                ...
                <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="owl-carousel testimonial-carousel">
                        <div class="testimonial-item">
                            <img class="img-fluid mb-3" src="{{ asset('frontend_assets/img/testimonial-1.jpg') }}" alt="">
                        ...
                        <div class="testimonial-item">
                            <img class="img-fluid mb-3" src="{{ asset('frontend_assets/img/testimonial-2.jpg') }}" alt="">
                        ...
                        <div class="testimonial-item">
                            <img class="img-fluid mb-3" src="{{ asset('frontend_assets/img/testimonial-3.jpg') }}" alt="">
                        ...
                        <div class="testimonial-item">
                            <img class="img-fluid mb-3" src="{{ asset('frontend_assets/img/testimonial-4.jpg') }}" alt="">
