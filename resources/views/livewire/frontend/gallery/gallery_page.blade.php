                    ...
                    <div class="row g-0">
                        <div class="col-12">
                            <a class="d-block" href="{{asset('frontend_assets/img/gallery-5.jpg')}}" data-lightbox="gallery">
                                <img class="img-fluid" src="{{asset('frontend_assets/img/gallery-5.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="col-12">
                            <a class="d-block" href="{{asset('frontend_assets/img/gallery-1.jpg')}}" data-lightbox="gallery">
                                <img class="img-fluid" src="{{asset('frontend_assets/img/gallery-1.jpg')}}" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-0">
                        <div class="col-12">
                            <a class="d-block" href="{{asset('frontend_assets/img/gallery-2.jpg')}}" data-lightbox="gallery">
                                <img class="img-fluid" src="{{asset('frontend_assets/img/gallery-2.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="col-12">
                            <a class="d-block" href="{{asset('frontend_assets/img/gallery-6.jpg')}}" data-lightbox="gallery">
                                <img class="img-fluid" src="{{asset('frontend_assets/img/gallery-6.jpg')}}" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-0">
                        <div class="col-12">
                            <a class="d-block" href="{{asset('frontend_assets/img/gallery-7.jpg')}}" data-lightbox="gallery">
                                <img class="img-fluid" src="{{asset('frontend_assets/img/gallery-7.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="col-12">
                            <a class="d-block" href="{{asset('frontend_assets/img/gallery-3.jpg')}}" data-lightbox="gallery">
                                <img class="img-fluid" src="{{asset('frontend_assets/img/gallery-3.jpg')}}" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-0">
                        <div class="col-12">
                            <a class="d-block" href="{{asset('frontend_assets/img/gallery-4.jpg')}}" data-lightbox="gallery">
                                <img class="img-fluid" src="{{asset('frontend_assets/img/gallery-4.jpg')}}" alt="">
                            </a>
                        </div>
                        <div class="col-12">
                            <a class="d-block" href="{{asset('frontend_assets/img/gallery-8.jpg')}}" data-lightbox="gallery">
                                <img class="img-fluid" src="{{asset('frontend_assets/img/gallery-8.jpg')}}" alt="">
                            </a>
                        </div>
                    </div>
                </div>
